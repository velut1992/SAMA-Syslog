...
/**
 *  The "legacy" Dashboards uses Hapi server + even-better plugin to log, so we should
 *  use the same approach here to make log records generated by the core to look the
 *  same as the rest of the records generated by the "legacy" Dashboards. But to reduce
...
export class LegacyLoggingServer {
  ...
  constructor(legacyLoggingConfig: Readonly<LegacyVars>) {
    ...
    // logged by the "legacy" Dashboards.
    const config = {
      logging: {
        ...legacyLoggingConfig,
        events: {
