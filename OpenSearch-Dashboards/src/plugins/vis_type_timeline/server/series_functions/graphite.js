...
export default new Datasource('graphite', {
  ...
  help: i18n.translate('timeline.help.functions.graphiteHelpText', {
    defaultMessage: `[experimental] Pull data from graphite. Configure your graphite server in Dashboards's Advanced Settings`,
  }),
    ...
    if (!isValidConfig(blockedIPs, allowedUrls, configuredUrl)) {
      throw new Error(
        i18n.translate('timeline.help.functions.invalidGraphiteConfig', {
          defaultMessage: `The Graphite URL provided by you is invalid. Please update your config from Dashboards' Advanced Settings.`,
        })
      );
    }
